...
if __name__ == "__main__":
    ...
    imshow(torchvision.utils.make_grid(images), labels, classes=classes)
    ...
    imshow(torchvision.utils.make_grid(images), labels, predictions=predicted, classes=classes)
